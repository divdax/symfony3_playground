...
use ApiBundle\Services\Api\HttpRequest;
...
class easybill
{
    ...
    protected function constructRequest($api_key) {
        return new HttpRequest($this->api_endpoint, $api_key);
    }
     ...
     * @return mixed
     */
    public function getDocuments($attributes = null)
    {
        return $this->request->get('documents', $attributes);
    }
